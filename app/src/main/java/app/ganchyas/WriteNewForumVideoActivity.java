...
/**
 * Allows the user to upload a forum with a video
 * @author Paradox
 */
public class WriteNewForumVideoActivity extends AppCompatActivity {
    ...
    /**
     * Uri of the video needed to be uploaded
     */
    Uri videoUri;
    /**
    ...
    /**
     * Overriding onCreate to Inflate custom UI using activity_write_new_forum_video.xml
    ...
    public void submitForumAction(View view) {
        ...
        if (videoUri != null) {
            ...
            CommonMethods.toastMessage(WriteNewForumVideoActivity.this, "Video is required");
        }
    }
    ...
    public void uploadFile() {
        ...
        final StorageReference videoRef = completeStorageReference.child("forum videos/" + identifier + "." + getFileExtension(videoUri));
        videoRef.putFile(videoUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            @Override
            ...
            public void onFailure(@NonNull Exception e) {
                CommonMethods.toastMessage(WriteNewForumVideoActivity.this, "uploading failed");
            }
        });
